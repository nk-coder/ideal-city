    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">                 
                   <?php 
                        $viewQuery = mysqli_query($con, "SELECT * FROM post WHERE approved='NO' ORDER BY date_time ASC");
                            ...
                            <div class="table-wrapper-scroll-y">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="unapprovedPostDetails.php?id=<?php echo $postId; ?>"><span class="btn btn-info">Live Preview</span></a> 
                                        </td>
                                    </tr>
